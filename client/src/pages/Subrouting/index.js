...
const Subrouting = ({ match }) => (
  <div>
    <h2>Subrouting example</h2>
    <ul>
      <li>
        <Link to={`${match.url}/babel`}>Babel</Link>
      </li>
      <li>
    ...
    <Route path={`${match.url}/babel`} component={BabelSubroute} />
    <Route path={`${match.url}/grid`} component={GridSubroute} />
...
class GridSubroute extends Component {
  constructor(props) {
    super(props);
  }
